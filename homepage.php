...
<body>
	...
	<div style="text-align: center;"> <h1> Welcome to Road Runner Productions</h1>
<br><br>
	<a href="homepage.php"><img  id="logo" src="per_1_roadrunners.png" alt="logo" align="center"/></a>
	<h4 align="center">Intro:</h4>
	<p align="center">Welcome to Road Runner Production Animation Studios. <hr width="200px" color="#0088ff">
	...
	<img src="animationstudio.jpg" alt="Studio Working People"> 
		...
		<p>
			<?php
print "Hello World! Sus among us ";
?>
		</p>	
		</div>
